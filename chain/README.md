...
2. It will call `progC`, passing environment variable `INPUT=./path/progC_3.socket` to it (template: `{storage directory}{OS path separator}{program file name}_{subprogram number}.socket`)
